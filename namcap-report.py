...
"""
	...
	print >>f, "<p>namcap.log was last generated on %s.</body></html>" % last_updated
	f.close()
...
""" % (t, t, t, tagclass(t, errors, warnings), tagclass(t, errors, warnings), t, t, tagclass(t, errors, warnings), tagscribe.has_key(t) and tagscribe[t] or "<p>"+tags[t]+"</p>", t)
		...
		print >>f, "</ul>"
		print >>f, "<hr/><p>Generated by <i>namcap-report</i> on basis of namcap.log of %s.</p></body></html>" % last_updated
		f.close()
